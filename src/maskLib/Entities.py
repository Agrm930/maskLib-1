...
class SolidPline(SubscriptAttributes):
    ...
    def _build_polyline(self):
        ...
        log_points(self.transformed_points)
...
# ===============================================================================
# ported from personal work in the chakramlab/maskLib clone, for use in
# Fast_Flux designs (Star itself authored upstream, kept as a dependency)
# ===============================================================================
